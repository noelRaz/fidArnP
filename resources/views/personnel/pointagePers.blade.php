...
@section('content')
    <div class="card">
        <div class="card-header">
          <h3 class="card-title">Pointage personnel</h3>
        ...
        <div class="card-body">
            <div class="pull-right">
                <!--<x-button href="#" class="btnplus btn1" data-toggle="modal" data-target="#ModalCreate">
            ...
            <table id="liste" class="table-style" style="width:100">
                ...
                <tbody class="w-4">
                    ...
                    <tr>
                        ...
                        <td>{{$item->persFonc}}</td>
                        <td>{!! DNS2D::getBarcodeHTML("$item->pointCodePers", 'QRCODE',2, 2) !!}</td>
